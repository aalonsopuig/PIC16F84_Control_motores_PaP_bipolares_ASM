; Motor04
; Programa para contol de motores paso a paso bipolares 
...
Ciclo	movlw	b'00000001'		; un paso del motor
	movwf	PORTB
	...
	movlw	b'00000100'		; un paso del motor
	movwf	PORTB
	Movf	Velocidad,W		; valor inverso de velocidad...
	movwf	Contador		;...se carga en "contador"
	call	Retardo	

	movlw	b'00000010'		; un paso del motor
	movwf	PORTB
	Movf	Velocidad,W		; valor inverso de velocidad...
	movwf	Contador		;...se carga en "contador"
	call	Retardo	

	movlw	b'00001000'		; un paso del motor
	movwf	PORTB
	Movf	Velocidad,W		; valor inverso de velocidad...
	movwf	Contador		;...se carga en "contador"
	call	Retardo	
